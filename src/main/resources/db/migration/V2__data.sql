...
INSERT INTO transaction(id, product_id, quantity, sub_total, courier_cost, total, inquiry_code, status)
VALUES(nextval('transaction_id_seq'), 1, 1, 250000, null, null, '9d383ce4-b2ee-4ef9-875f-6aed586d337f', 'INQUIRED'),
      (nextval('transaction_id_seq'), 5, 3, 60000, 10000, 70000, '8d383ce4-b2ee-4ef9-875f-6aed586d337f', 'SUCCESS'),
      (nextval('transaction_id_seq'), 3, 2, 160000, 15000, 175000, '7d383ce4-b2ee-4ef9-875f-6aed586d337f', 'FAILED');
